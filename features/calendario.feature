...
Dado que estou registrado no sistema
Dado que eu estou logado no sistema
E que eu agendei "1" serviços para a data "23/12/2022" e horários a partir das "10:00" até as "17:00"
Quando eu for redirecionado para a página de dashboard
Quando eu clicar no dia "2022-12-23"
Então eu devo ver uma lista de agendamentos da data "23/12/2022"
E a lista deve conter "1" agendamentos
...
Dado que estou registrado no sistema
Dado que eu estou logado no sistema
E que eu agendei "5" serviços para a data "23/12/2022" e horários a partir das "12:00" até as "17:00"
Quando eu for redirecionado para a página de dashboard
E eu clicar no dia "2022-12-23"
Então eu devo ver uma lista de agendamentos da data "23/12/2022"
E a lista deve conter "5" agendamentos
E cada agendamento deve conter o nome do barbeiro e o horário do agendamento
E os horários dos agendamentos devem ser até as "17:00" horas
...
Dado que estou registrado no sistema
Dado que eu estou logado no sistema
E que eu agendei "3" serviços para a data "23/12/2022" e horários a partir das "10:00" até as "15:00"
...
Dado que estou registrado no sistema
Dado que eu estou logado no sistema
E que eu agendei "2" serviços para a data "23/12/2022" e horários a partir das "10:00" até as "15:00"
